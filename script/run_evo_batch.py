...
Loads existing VIO trajectory outputs (TUM csv) and computes APE/RPE via the
evo Python API, without re-running VIO.
'''
import os
import sys
import argparse
...
ALL_CASES = ["MH_01_easy", "MH_02_easy", "MH_03_medium", "V1_01_easy", "V1_02_medium", "V1_03_difficult", "V2_01_easy", "V2_02_medium", "V2_03_difficult"]
