...
class CameraModel {
 public:
  ...
  void CalculateUndistortRectifyMap(const Eigen::Matrix3d& K,
                                    const Eigen::VectorXd& D,
                                    Eigen::Matrix3d& K_undistort, cv::Mat& map1,
                                    cv::Mat& map2);
  ...
  void RectifyStereoImages(const cv::Mat& img_left, const cv::Mat& img_right,
                           cv::Mat& rectified_left, cv::Mat& rectified_right);
